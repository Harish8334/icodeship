  ...
  return (
    <div className="capable_services_container">
      <section className="position-relative">
        ...
        <div
          key={idx}
          className={`row mb-5 capable_service_data ${idx % 2 !== 0 ? "flex-row-reverse" : ""}`}
     
        >
          <div className="col-12 col-lg-6 col-md-6">
            <div className="position-relative">
              <p className="f font-size-58 font_weight_600 mt-3">{service.title}</p>
              ...
              <div className="d-flex flex-column gap-3 mt-5">
                {service.points.map((point, index) => (
                  ...
                  >
                    <ChevronRight strokeWidth={1} size={40} className="mt-1 font-size-40" />
                    <p className="pt-2 pt-lg-0 font-size-30 font_weight_600 m-0">{point.text}</p>
                  </a>
          ...
          <div className="col-12 col-lg-6 col-md-6">
            <img src={service.image} alt={service.title} className="img-fluid mt-5 mt-lg-0" />
          </div>
        </div>
      ))}

        </Container>
        <img src={Shape_4} alt="" className="img-fluid  position-absolute work_togehter_shape mt-5 " />
      </section>
     <div className="">
     <WorkTogther/>
     </div>
